 ...
 */
@AnalyticsName(value="rdf-namespace-stats")
...
public class RDFDomainNamespaceStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFDomainNamespaceStats() {
    super();
  }

  public RDFDomainNamespaceStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    return new Each(previous[0], Analytics.getHeadFields(this),
      new RDFDomainNamespaceFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
  }
