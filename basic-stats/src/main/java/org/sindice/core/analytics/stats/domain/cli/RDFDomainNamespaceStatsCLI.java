...
import org.sindice.core.analytics.stats.domain.rdf.RDFDomainNamespaceStats;
 ...
 */
public class RDFDomainNamespaceStatsCLI extends AbstractAnalyticsCLI {

  private static final String DATE = "date";

  private static final Logger logger = LoggerFactory
      .getLogger(RDFDomainNamespaceStatsCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        RDFDomainNamespaceStatsCLI.class);
    ...
    final RDFDomainNamespaceStats pipe = new RDFDomainNamespaceStats();
    ...
    logger.info("Generate rdf for domain namespace stats");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final RDFDomainNamespaceStatsCLI cli = new RDFDomainNamespaceStatsCLI();
