 ...
 */
public class CountClassPerDomainCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(CountClassPerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties, CountClassPerDomainCLI.class);
    ...
    final CountClassPerDomain pipe = new CountClassPerDomain();
  ...
  public static void main(final String[] args) throws Exception {
    final CountClassPerDomainCLI cli = new CountClassPerDomainCLI();
