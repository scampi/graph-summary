...
public class RDFDomainTripleStats
extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFDomainTripleStats() {
    super();
  }

  public RDFDomainTripleStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    return new Each(previous[0], Analytics.getHeadFields(this),
      new RDFDomainTripleFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
  }
