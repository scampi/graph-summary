...
public class RDFDomainClassStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFDomainClassStats() {
    super();
  }

  public RDFDomainClassStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    return new Each(previous[0], Analytics.getHeadFields(this),
      new RDFDatasetClassFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
  }
