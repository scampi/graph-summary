...
import org.sindice.core.analytics.stats.domain.rdf.RDFDomainPatternStats;
 ...
 */
public class RDFDomainPatternStatsCLI extends AbstractAnalyticsCLI {

  private static final String DATE = "date";

  private static final Logger logger = LoggerFactory
      .getLogger(RDFDomainPatternStatsCLI.class);
  ...
  throws Exception {
    ...
    AppProps
        .setApplicationJarClass(properties, RDFDomainPatternStatsCLI.class);
    ...
    final RDFDomainPatternStats pipe = new RDFDomainPatternStats();
    ...
    logger.info("Generate rdf for domain pattern stats");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final RDFDomainPatternStatsCLI cli = new RDFDomainPatternStatsCLI();
