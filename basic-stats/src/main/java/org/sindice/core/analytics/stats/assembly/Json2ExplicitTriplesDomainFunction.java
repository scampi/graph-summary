 ...
 * @author diego
 */
public class Json2ExplicitTriplesDomainFunction
extends BaseOperation<Json2ExplicitTriplesDomainFunction.Context>
implements Function<Json2ExplicitTriplesDomainFunction.Context> {

  private static final Logger logger           = LoggerFactory.getLogger(Json2ExplicitTriplesDomainFunction.class);
  ...
  public Json2ExplicitTriplesDomainFunction(Fields fieldDeclaration) {
    super(fieldDeclaration);
  }

  public Json2ExplicitTriplesDomainFunction() {
    this(new Fields("sndDomain", "domain-Hash", "nTriple"));
  }
  ...
  public void operate(FlowProcess flowProcess, FunctionCall<Context> functionCall) {
    ...
    try {
      ...
      Long domainhash = Hash.getHash64(domain);

      c.tuple.clear();
      c.tuple.addAll(datasetLabel, domainhash, triples.size());
