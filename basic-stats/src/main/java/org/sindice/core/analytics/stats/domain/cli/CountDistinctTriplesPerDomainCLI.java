...
import org.sindice.core.analytics.stats.domain.assembly.CountDistinctTriplesPerDomain;
 ...
 */
public class CountDistinctTriplesPerDomainCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(CountDistinctTriplesPerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        CountDistinctTriplesPerDomainCLI.class);

    final CountDistinctTriplesPerDomain pipe = new CountDistinctTriplesPerDomain();
    ...
    logger.info("Start counting number of distinct triples per domain");
  ...
  public static void main(final String[] args) throws Exception {
    final CountDistinctTriplesPerDomainCLI cli = new CountDistinctTriplesPerDomainCLI();
