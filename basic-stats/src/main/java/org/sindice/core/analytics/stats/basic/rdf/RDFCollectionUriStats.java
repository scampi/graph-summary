...
@AnalyticsName(value="rdf-uri-stats")
@AnalyticsHeadPipes(values={
  @AnalyticsPipe(from=BasicUriStats.class)
})
@AnalyticsTailPipes(values={
  @AnalyticsPipe(fields={ "rdf" })
})
public class RDFCollectionUriStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFCollectionUriStats() {
    super();
  }

  public RDFCollectionUriStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    Pipe pipe = new Each(previous[0],
      new RDFCollectionUriFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
    return pipe;
  }
