 ...
 */
public class CountPredicatePerDomainCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(CountPredicatePerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        CountPredicatePerDomainCLI.class);

    final CountPredicatePerDomain pipe = new CountPredicatePerDomain();
    ...
    logger.info("Start counting number of predicates per domain");
    flow.complete();
    return flow;
  }
  ...
  throws Exception {
    final CountPredicatePerDomainCLI cli = new CountPredicatePerDomainCLI();
