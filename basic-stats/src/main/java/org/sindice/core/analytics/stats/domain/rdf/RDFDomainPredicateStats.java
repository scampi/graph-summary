...
public class RDFDomainPredicateStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFDomainPredicateStats() {
    super();
  }

  @Override
  protected Object assemble(Pipe[] previous, Object... args) {
    return new Each(previous[0],
      new RDFDomainPredicateFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
  }
