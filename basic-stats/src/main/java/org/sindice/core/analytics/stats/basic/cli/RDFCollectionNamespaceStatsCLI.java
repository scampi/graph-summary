...
public class RDFCollectionNamespaceStatsCLI extends AbstractAnalyticsCLI {
  ...
  throws Exception {
    ...
    final Tap source = new Hfs(getInputScheme(Analytics.getHeadFields(RDFCollectionNamespaceStats.class)), input.get(0));
    final Tap sink = new Hfs(new ExtensionTextLine("nq", Compress.ENABLE), output.get(0), SinkMode.REPLACE);
    AppProps.setApplicationJarClass(properties, RDFCollectionNamespaceStatsCLI.class);
    final RDFCollectionNamespaceStats pipe = new RDFCollectionNamespaceStats();
  ...
  public static void main(final String[] args) throws Exception {
    final RDFCollectionNamespaceStatsCLI cli = new RDFCollectionNamespaceStatsCLI();
