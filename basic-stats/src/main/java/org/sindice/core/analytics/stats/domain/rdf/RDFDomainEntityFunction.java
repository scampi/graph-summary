 ...
 */
public class RDFDomainEntityFunction
extends AbstractRDFDatasetFunction {

  private static final long serialVersionUID = 5332839243356225365L;

  public RDFDomainEntityFunction(final Fields fieldDeclaration) {
  ...
  public void operate(FlowProcess flowProcess,
    ...
    final Long nEntity = arguments.getLong("nEntity");
    ...
    final Literal nEntityLit = cxt.value.createLiteral(nEntity);
    ...
    super.writeStatement(cxt, functionCall.getOutputCollector(), bnode,
        cxt.totalEntities, nEntityLit, cxt.graphName);
  }
