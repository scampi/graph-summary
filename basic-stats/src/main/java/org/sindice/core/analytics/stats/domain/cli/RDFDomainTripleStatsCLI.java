...
import org.sindice.core.analytics.stats.domain.rdf.RDFDomainTripleStats;
 ...
 */
public class RDFDomainTripleStatsCLI extends AbstractAnalyticsCLI {

  private static final String DATE = "date";

  private static final Logger logger = LoggerFactory
      .getLogger(RDFDomainTripleStatsCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties, RDFDomainTripleStatsCLI.class);
    ...
    if (options.has(DATE)) {
      ...
      printMissingOptionError(DATE);
		...
		final RDFDomainTripleStats pipe = new RDFDomainTripleStats();
    ...
    logger.info("Generate rdf for domain class stats");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final RDFDomainTripleStatsCLI cli = new RDFDomainTripleStatsCLI();
