 ...
 */
public class RDFCollectionPredicateFunction
extends AbstractRDFCollectionFunction {

  private static final long serialVersionUID = 5038737465393537157L;

  public RDFCollectionPredicateFunction(final Fields fieldDeclaration) {
  ...
  public void operate(FlowProcess flowProcess,
    ...
    // Get the fields
    final String predicate = args.getString("predicate");
    ...
    super.writeStatement(cxt, functionCall.getOutputCollector(), bnode, cxt.statsName, cxt.colPredStat, cxt.graphName);
