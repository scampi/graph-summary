...
@AnalyticsHeadPipes(values={
  @AnalyticsPipe(fields={ "domain", "nEntity" })
})
@AnalyticsTailPipes(values={
  @AnalyticsPipe(fields={ "output" })
})
public class RDFDomainEntityStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFDomainEntityStats() {
    super();
  }

  public RDFDomainEntityStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    return new Each(previous[0], Analytics.getHeadFields(this),
      new RDFDomainEntityFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
  }
