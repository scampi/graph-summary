 ...
 */
@AnalyticsName(value="rdf-predicate-stats")
@AnalyticsHeadPipes(values={
  @AnalyticsPipe(from=BasicPredicateStats.class)
})
@AnalyticsTailPipes(values={
  @AnalyticsPipe(fields={ "rdf" })
})
public class RDFCollectionPredicateStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFCollectionPredicateStats() {
    super();
  }

  public RDFCollectionPredicateStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    Pipe pipe = new Each(previous[0],
      new RDFCollectionPredicateFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
    return pipe;
  }
