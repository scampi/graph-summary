...
import org.sindice.core.analytics.stats.domain.assembly.CountPatternPerDomain;
 ...
 */
public class CountPatternPerDomainCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(CountPatternPerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps
        .setApplicationJarClass(properties, CountPatternPerDomainCLI.class);

    final CountPatternPerDomain pipe = new CountPatternPerDomain();
    ...
    logger.info("Start counting number of patterns ndoes per domain");
  ...
  public static void main(final String[] args) throws Exception {
    final CountPatternPerDomainCLI cli = new CountPatternPerDomainCLI();
