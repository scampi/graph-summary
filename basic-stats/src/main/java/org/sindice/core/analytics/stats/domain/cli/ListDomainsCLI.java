...
import org.sindice.core.analytics.stats.domain.assembly.ListDomains;
 ...
 */
public class ListDomainsCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(ListDomainsCLI.class);

  /**
   * Generates a list a list of domains from the input documents, typically
   * calculated at request of Gabi or Guilio
   */
  @Override
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties, ListDomainsCLI.class);

    final ListDomains pipe = new ListDomains();
    ...
    logger.info("Start listing domains");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final ListDomainsCLI cli = new ListDomainsCLI();
