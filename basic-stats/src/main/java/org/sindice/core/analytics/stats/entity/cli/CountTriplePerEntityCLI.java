 ...
 *******************************************************************************/
package org.sindice.core.analytics.stats.entity.cli;
...
import org.sindice.core.analytics.stats.entity.assembly.CountTriplePerEntity;
 ...
 */
public class CountTriplePerEntityCLI extends AbstractAnalyticsCLI {

  public CountTriplePerEntityCLI() {
    super();
  }

  private static final Logger logger = LoggerFactory
      .getLogger(CountTriplePerEntityCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties, CountTriplePerEntityCLI.class);

    final CountTriplePerEntity pipe = new CountTriplePerEntity();
    ...
    logger.info("Start counting number of triples per entity");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final CountTriplePerEntityCLI cli = new CountTriplePerEntityCLI();
