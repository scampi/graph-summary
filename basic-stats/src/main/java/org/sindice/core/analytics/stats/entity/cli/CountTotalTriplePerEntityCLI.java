 ...
 */
public class CountTotalTriplePerEntityCLI extends AbstractAnalyticsCLI {

  public CountTotalTriplePerEntityCLI() {
    super();
  }

  private static final Logger logger = LoggerFactory
      .getLogger(CountTotalTriplePerEntityCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        CountTotalTriplePerEntityCLI.class);

    final CountTotalTriplePerEntity pipe = new CountTotalTriplePerEntity();
  ...
  public static void main(final String[] args) throws Exception {
    final CountTotalTriplePerEntityCLI cli = new CountTotalTriplePerEntityCLI();
