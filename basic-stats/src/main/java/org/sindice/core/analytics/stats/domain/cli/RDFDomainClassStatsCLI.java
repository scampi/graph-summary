 ...
 */
public class RDFDomainClassStatsCLI extends AbstractAnalyticsCLI {

  private static final String DATE = "date";

  private static final Logger logger = LoggerFactory
      .getLogger(RDFDomainClassStatsCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties, RDFDomainClassStatsCLI.class);
    ...
    final RDFDomainClassStats pipe = new RDFDomainClassStats();
    final Tap source = new Hfs(getInputScheme(Analytics.getHeadFields(pipe)), input.get(0));
    final Tap sink = new Hfs(new TextLine(Analytics.getTailFields(pipe)),
  ...
  public static void main(final String[] args) throws Exception {
    final RDFDomainClassStatsCLI cli = new RDFDomainClassStatsCLI();
