...
import org.sindice.core.analytics.stats.domain.rdf.RDFDomainPredicateStats;
 ...
 */
public class RDFDomainPredicateStatsCLI extends AbstractAnalyticsCLI {

  private static final String DATE = "date";

  private static final Logger logger = LoggerFactory
      .getLogger(RDFDomainPredicateStatsCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        RDFDomainPredicateStatsCLI.class);
    ...
    final RDFDomainPredicateStats pipe = new RDFDomainPredicateStats();
    ...
    logger.info("Generate rdf for domain predicate stats");
    flow.complete();
    return flow;
  }

  public static void main(final String[] args) throws Exception {
    final RDFDomainPredicateStatsCLI cli = new RDFDomainPredicateStatsCLI();
