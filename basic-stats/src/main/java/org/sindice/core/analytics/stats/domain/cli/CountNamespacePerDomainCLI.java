...
import org.sindice.core.analytics.stats.domain.assembly.CountNamespacePerDomain;
 ...
 */
public class CountNamespacePerDomainCLI extends AbstractAnalyticsCLI {

  private static final Logger logger = LoggerFactory
      .getLogger(CountNamespacePerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps.setApplicationJarClass(properties,
        CountNamespacePerDomainCLI.class);

    final CountNamespacePerDomain pipe = new CountNamespacePerDomain();
    ...
    logger.info("Start counting number of namespaces per domain");
		flow.complete();
		return flow;
	}

  public static void main(final String[] args) throws Exception {
    final CountNamespacePerDomainCLI cli = new CountNamespacePerDomainCLI();
