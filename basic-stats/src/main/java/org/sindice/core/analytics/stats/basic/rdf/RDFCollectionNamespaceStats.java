...
@AnalyticsName(value="rdf-ns-stats")
@AnalyticsHeadPipes(values={
  @AnalyticsPipe(from=BasicNamespaceStats.class)
})
@AnalyticsTailPipes(values={
  @AnalyticsPipe(fields={ "rdf" })
})
public class RDFCollectionNamespaceStats extends AnalyticsSubAssembly {

  private static final long serialVersionUID = 1L;

  public RDFCollectionNamespaceStats() {
    super();
  }

  public RDFCollectionNamespaceStats(Pipe[] pipes) {
  ...
  protected Object assemble(Pipe[] previous, Object... args) {
    Pipe pipe = new Each(previous[0], Analytics.getHeadFields(this),
      new RDFCollectionNamespaceFunction(Analytics.getTailFields(this)),
      Fields.RESULTS);
    return pipe;
  }
