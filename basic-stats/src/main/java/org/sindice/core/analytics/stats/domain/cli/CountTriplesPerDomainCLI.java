 ...
 */
public class CountTriplesPerDomainCLI extends AbstractAnalyticsCLI {

  public CountTriplesPerDomainCLI() {
    super();
  }

  private static final Logger logger = LoggerFactory
      .getLogger(CountTriplesPerDomainCLI.class);
  ...
  throws Exception {
    ...
    AppProps
        .setApplicationJarClass(properties, CountTriplesPerDomainCLI.class);

    final CountTriplesPerDomain pipe = new CountTriplesPerDomain();
  ...
  public static void main(final String[] args) throws Exception {
    final CountTriplesPerDomainCLI cli = new CountTriplesPerDomainCLI();
