 ...
 */
public class DomainPatternTest extends AbstractAnalyticsTestCase {

  protected final static String jsonPath = "./src/test/resources/pattern-input.json";
  ...
  public void Test() throws IOException {
    ...
    Pipe parse = new CountPatternPerDomain();
    ...
    expectedTuples.add(domain3 + "\t1\t1\t1\t1\t1\t1\t6");
    expectedTuples.add(domain1 + "\t3\t0\t0\t0\t0\t0\t3");
    expectedTuples.add(domain2 + "\t4\t0\t0\t2\t0\t0\t6");
