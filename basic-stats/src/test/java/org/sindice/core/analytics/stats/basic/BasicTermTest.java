...
extends AbstractAnalyticsTestCase {
  ...
  private final static String jsonPath = "./src/test/resources/term-input.json";

  @Test
  public void Test()
  throws IOException {
    final BasicTermStats parse = new BasicTermStats();
    ...
    expectedTuples.add("literal1\t1\t1\t1\t1");
    expectedTuples.add("literal2\t3\t3\t3\t2");
