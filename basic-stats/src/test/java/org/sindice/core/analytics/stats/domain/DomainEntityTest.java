 ...
 */
public class DomainEntityTest extends AbstractAnalyticsTestCase {
  ...
  public void Test() throws IOException {
    ...
    Pipe parse = new CountEntityPerDomain();
    ...
    expectedTuples.add(domain3 + "\t4");
    expectedTuples.add(domain1 + "\t4");
    expectedTuples.add(domain2 + "\t5");
    ...
    while (iterator.hasNext()) {
      ...
      assertEquals(expectedTuples.get(nTuple), tuple.getTuple().toString());
      nTuple++;
    }
