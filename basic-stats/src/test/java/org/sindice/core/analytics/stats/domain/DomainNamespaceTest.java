 ...
 */
public class DomainNamespaceTest extends AbstractAnalyticsTestCase {
  ...
  public void Test() throws IOException {
    ...
    Pipe parse = new CountNamespacePerDomain();
    ...
    expectedTuples.add(domain1 + "\t" + domain1 + "/\t1\t1");
    expectedTuples.add(domain3 + "\t" + pred + "\t2\t1");
    expectedTuples.add(domain1 + "\t" + pred + "\t2\t1");
    expectedTuples.add(domain2 + "\t" + domain1 + "/\t6\t2");
